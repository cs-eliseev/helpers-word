    ...
    public function providerConvertUnsignedIntNumberToWord(): array
    {
        return [
            ...
            [
                ...
                null,
                PHP_INT_SIZE === 4
                    ? 'девятьсот восемьдесят семь квадриллионов шестьсот пятьдесят четыре триллиона триста двадцать один миллиард девяносто восемь миллионов семьсот шестьдесят пять тысяч четыреста сорок'
